...
- Download individual tours as `.ics` calendar files enriched with route details, equipment, accommodation, and cost info fetched from the tour detail page; also generates a linked all-day reminder event for the registration opening date with a Zurich-midnight alert
